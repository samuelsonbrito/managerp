...
; (function ($, window, document, undefined) {
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setToolbar: function () {
            ...
            var btnNext = $('#avancar');
            var btnPrevious = $('#voltar');
            var btnGroup = $('<div></div>').addClass('btn-group mr-2 sw-btn-group pull-right').attr('role', 'group').append(btnPrevious, btnNext);
