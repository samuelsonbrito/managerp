...
@section('content_header')
    <h1>
        ...
        <small>Gerencie os Feriados</small>
    </h1>
    <ol class="breadcrumb">
...
@section('content')
    <div id="app">
        ...
        <box boxtipo="box-success" boxtitulo="FERIADOS">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="table-responsive">
                        {!! $dataTable->table(['id' => 'tabela-feriados']) !!}
                    </div>
                </div>
            </div>
        </box>
        @include('feriado.includes.modal-cadastrar-feriado')
    </div>
