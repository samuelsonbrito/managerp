    ...
    <table width="100%" style="padding-top: 15px; padding-left: 13px; padding-right: 15px">
        ...
        <tr>
            ...
            <td align="right" style="width: 60%;">
                ...
                <h6 align="right"><p style="padding-bottom: -13px; font-size: 12px">COLABORADORES COM CONSELHOS PRESTES A VENCER</p></h6>
...
<table id="conteudo-tabela">
    <thead>
    <tr id="tr-conteudo">
        <th id="th-conteudo">NOME</th>
        <th id="th-conteudo">NÚMERO DO CONSELHO</th>
        <th id="th-conteudo">NOME DO CONSELHO</th>
        <th id="th-conteudo">VENCIMENTO</th>
    </tr>
    </thead>
    <tbody>
    @foreach($dados as $dado)
        <tr>
            ...
            <td id="td-conteudo">{{$dado->numero_conselho}}</td>
            <td id="td-conteudo">{{$dado->nome}}</td>
            <td id="td-conteudo">{{$dado->data_validade}}</td>
