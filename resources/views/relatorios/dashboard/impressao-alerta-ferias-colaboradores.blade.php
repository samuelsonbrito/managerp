    ...
    <table width="100%" style="padding-top: 15px; padding-left: 13px; padding-right: 15px">
        ...
        <tr>
            ...
            <td align="right" style="width: 60%;">
                ...
                <h6 align="right"><p style="padding-bottom: -13px; font-size: 12px">ALERTA DE FÉRIAS A PARTIR DE 18 MESES DA ADMISSÃO</p></h6>
...
<table id="conteudo-tabela">
    ...
    <tr id="tr-conteudo">
        ...
        <th id="th-conteudo">CARGO</th>
        <th id="th-conteudo">DATA DA ADMISSÃO</th>
    </tr>
    </thead>
    <tbody>
    ...
    @foreach($dados as $dado)
        <tr>
            ...
            <td id="td-conteudo">{{$dado->cargo_descricao}}</td>
            <td id="td-conteudo">{{$dado->data_admissao}}</td>
        </tr>
    @endforeach
    </tbody>
</table>
