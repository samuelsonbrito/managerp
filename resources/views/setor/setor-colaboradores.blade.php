...
@section('content_header')
    <h1>
        Gerenciamento dos Colaboradoes/Setor
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Setor/Colaboradores</li>
    </ol>
@stop
...
@section('content')
    <div id="app">
        ...
        <box boxtipo="box-success" boxtitulo="SETOR: {{$setor}}">
            <div class="row" style="margin-bottom: 1.5rem">
                <div class="col-md-12">
                    <a href="" data-toggle="modal" data-target="#modal-cadastrar" class="btn btn-primary"><i
                                class="fa fa-plus"></i> Adicionar Colaborador</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="table-responsive">
                        {!! $dataTable->table(['id' => 'tabela-colaboradores']) !!}
                    </div>
                </div>
            </div>
        </box>
        @include('setor.includes.modal-adicionar-colaborador')
    </div>
...
@section('js')
    ...
    <script src="{{ asset('js/setor/setor-colaborador.js') }}"></script>
