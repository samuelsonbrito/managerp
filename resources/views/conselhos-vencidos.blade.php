...
@section('content_header')
    <h1>
        ...
        <small>Conselhos Vencidos</small>
    </h1>
    <ol class="breadcrumb">
...
@section('content')
    <div id="app">
        ...
        <box boxtipo="box-success" boxtitulo="Colaboradores com Conselhos Vencidos">
            <div class="row" style="margin-bottom: 1.5rem">
                <div class="col-md-12">
                    <a href="{{route('imprimir.conselhos.vencidos')}}" target='_blank' class="btn btn-primary"><i
