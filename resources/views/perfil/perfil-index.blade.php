...
@section('content_header')
    <h1>
        Gerenciamento de Perfís
        <small>Gerencie os Perfís</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{route('admin.index')}}"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">Perfís</li>
    </ol>
@stop
...
@section('content')
    <div id="app">
        ...
        <box boxtipo="box-success" boxtitulo="PERFÍS">
        ...
        @include('perfil.includes.modal-adicionar-perfil')
