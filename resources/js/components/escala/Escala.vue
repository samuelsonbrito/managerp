                            ...
                            <td colspan="12">
                                <div class="input-group col-md-12">
                                    <span class="button-checkbox input-group-btn" v-for="elemento in elementos">
                                        <button type="button"
                                                :class="'btn '+getFerias(elemento, colaborador.colaborador_id)+' '+elemento.status_feriado"
...
<script>
    export default {
        props: ["escala", "unidade", "setor", "cargo", "colaboradores", "licencas", "feriados"],
        data() {
            return {
        ...
        methods: {
            ...
            getFerias: function (elemento, colaborador_id) {
                ...
                if(elemento.licenca.length > 0) {
                    ...
                    // console.log(value.colaborador_id)
                        });
                    return result
                }
        ...
        created: function () {
            ...
            for (var i = 1; i <= this.escala_dados.quantidade_dias; i++) {
                ...
                this.licencas_dados.forEach((value) => {
                        ...
                        // console.log(value.colaborador_id, elemento.colaborador_id)
